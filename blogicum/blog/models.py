...
from blog.constant import HEADER_MODEL_LEN, LEN_ADMIN_POST
...
class Comment(PublishedModel, models.Model):
    ...
    def __str__(self):
        return f'''Комментарий: {self.text[:LEN_ADMIN_POST]}
                от автора: {self.author}
                к публикации: "{self.post.title} '''
